...
mixin _$Note {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, projectId, content,
      createdBy, createdAt, updatedAt, title, updatedBy);

  @override
  String toString() {
    return 'Note(id: $id, projectId: $projectId, content: $content, createdBy: $createdBy, createdAt: $createdAt, updatedAt: $updatedAt, title: $title, updatedBy: $updatedBy)';
  }
}
