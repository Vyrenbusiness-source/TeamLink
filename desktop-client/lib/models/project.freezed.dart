...
mixin _$Project {
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, ownerId, createdAt, updatedAt, description);

  @override
  String toString() {
    return 'Project(id: $id, name: $name, ownerId: $ownerId, createdAt: $createdAt, updatedAt: $updatedAt, description: $description)';
  }
}
...
extension ProjectPatterns on Project {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String name, String ownerId, int createdAt,
            int updatedAt, String? description)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Project() when $default != null:
        return $default(_that.id, _that.name, _that.ownerId, _that.createdAt,
            _that.updatedAt, _that.description);
      case _:
        return orElse();
    }
  }
