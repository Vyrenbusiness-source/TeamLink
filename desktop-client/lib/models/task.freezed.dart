...
mixin _$Task {
  ...
  @override
  String toString() {
    return 'Task(id: $id, projectId: $projectId, title: $title, status: $status, createdAt: $createdAt, updatedAt: $updatedAt, description: $description, priority: $priority, assigneeId: $assigneeId, deadline: $deadline, updatedBy: $updatedBy)';
  }
}
